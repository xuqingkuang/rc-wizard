...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Wizard = __webpack_require__(4);
	...
	_Wizard2.default.Step = _Step2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _zh_CN = __webpack_require__(42);
	  ...
	  Wizard.prototype.render = function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      children.map(function (child, index) {
	        return _this2.renderPage(child, index, onDone);
	      })
	    );
	  };
	
	  Wizard.prototype.renderPage = function renderPage(child, index, onDone) {
	    var _this3 = this;
	    ...
	    var isFirst = this.childrenKeys.indexOf(child.key) === 0;
	    var isLast = this.childrenKeys.indexOf(child.key) === this.childrenKeys.length - 1;
	    var newChildProps = {
	      oldKey: child.key,
	      ...
	      onPrevious: function onPrevious() {
	        _this3.handleSteps(PREVIOUS, _onPrevious);
	      },
	      onNext: function onNext() {
	        _this3.handleSteps(NEXT, _onNext);
	      },
	      onDone: onDone
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Buttons = __webpack_require__(44);
	...
	var Step = function (_Component) {
	  ...
	  Step.prototype.renderButtons = function renderButtons() {
	    ...
	    var nextButton = _react2.default.createElement(_Buttons.NextButton, {
	      key: 'next',
	      locale: locale,
	      onClick: onNext
	    });
	
	    var doneButton = _react2.default.createElement(_Buttons.DoneButton, {
	      key: 'done',
	      locale: locale,
	      onClick: onDone
	    });
